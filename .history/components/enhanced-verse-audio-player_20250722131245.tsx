...
export function EnhancedVerseAudioPlayer({ ayah, totalVerses, className }: EnhancedVerseAudioPlayerProps) {
  ...
  useEffect(() => {
    ...
    const handleEnded = async () => {
      ...
      // Check BOTH global autoplay AND surah page verse autoplay (both must be enabled)
      const currentPreferences = storage.getPreferences()
      ...
      if (shouldAutoPlay) {
        try {
          ...
          if (nextVerseNumber <= totalVerses) {
            ...
            console.log(
              `Auto-playing next verse: ${nextVerseKey} (Global Auto Play: ${currentPreferences.autoPlay} AND Surah Page Auto Play: ${currentPreferences.surahPageVerseAutoPlay})`,
            )
        ...
        console.log(
          `Verse Auto Play disabled - Global Auto Play: ${currentPreferences.autoPlay}, Surah Page Auto Play: ${currentPreferences.surahPageVerseAutoPlay} (both must be enabled)`,
        )
        handleStop()
      }
    }
