...
export default function SurahDetailPage() {
  ...
  const { updateAutoPlayEnabled: updateVerseAutoPlay, updateVerseAudioEnabled } = useVerseAudio() // Get updateVerseAudioEnabled from context
  ...
  // const { state, playSurah, togglePlayPause, updateAutoPlay: updateSurahAutoPlay } = useAudio() // Renamed for clarity
  // const { setAutoPlayEnabled: updateVerseAutoPlay } = useVerseAudio() // Removed this line
  ...
  const updatePreferencesHandler = (key: keyof UserPreferences, value: any) => {
    ...
    // Update auto play state in respective providers
    if (key === "autoPlay") {
      updateSurahAutoPlay(value) // Update surah auto play in AudioProvider
      updateVerseAutoPlay(value) // Update verse auto play in VerseAudioProvider
    } else if (key === "verseAudioEnabled") {
      updateVerseAudioEnabled(value) // Update verse audio enabled in VerseAudioProvider
    }
  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => updatePreferencesHandler("fontSize", value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreferencesHandler("showTranslation", checked)}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) => updatePreferencesHandler("autoPlay", checked)}
                  />
